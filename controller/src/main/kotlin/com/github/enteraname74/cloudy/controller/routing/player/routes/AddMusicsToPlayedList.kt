...
import com.github.enteraname74.cloudy.controller.routing.player.model.AddMusicsToPlayedListBody
...
fun Route.addMusicsToPlayedList() {
    ...
    post<PlayerResource.AddMusics> {
        val body: AddMusicsToPlayedListBody = call.receive()
